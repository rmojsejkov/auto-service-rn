...
/**
 * Компонент, отвечающий за отображение экрана дополнительной информации об услуге по ДВС
 * @param navigation
 * @param props
 * @returns {JSX.Element}
 * @constructor
 */
const ServicesDetails = ({navigation, ...props}) => {
    const {
        serviceName,
        price,
        error,
...
/**
 * Функция, отображающая заголовок хэдера экрана дополнительной информации об услуге по ДВС.
 * @param navData
 * @returns {{headerLeft: (function()), headerTitle: string}}
 */
export const servicesDetailsOptions = navData => {
    return {
